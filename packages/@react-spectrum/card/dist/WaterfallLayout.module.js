...
import {getFirstItem as $bRzF0$getFirstItem, getChildNodes as $bRzF0$getChildNodes} from "@react-stately/collections";
import {Rect as $bRzF0$Rect, LayoutInfo as $bRzF0$LayoutInfo, Size as $bRzF0$Size} from "@react-stately/virtualizer";
...
class $03278f8d0f6860bb$export$e9f7cda058ba8df8 extends (0, $3d424c147206bac9$export$64943d2e59d72a29) {
    ...
    buildCollection(invalidationContext) {
        ...
        for (let node of this.collection){
            ...
            let rect = new (0, $bRzF0$Rect)(x, y, itemWidth, height);
            let layoutInfo = new (0, $bRzF0$LayoutInfo)(node.type, key, rect);
    ...
    getClosestRight(key) {
        ...
        let rect = new (0, $bRzF0$Rect)(layoutInfo.rect.maxX + 1, layoutInfo.rect.y, layoutInfo.rect.width + this.horizontalSpacing, layoutInfo.rect.height);
        ...
        if (!key) {
            ...
            rect = new (0, $bRzF0$Rect)(layoutInfo.rect.maxX + 1, 0, layoutInfo.rect.width + this.horizontalSpacing, this.virtualizer.contentSize.height);
        ...
        return (_getFirstItem = (0, $bRzF0$getFirstItem)((0, $bRzF0$getChildNodes)(item, this.collection))) === null || _getFirstItem === void 0 ? void 0 : _getFirstItem.key;
    }
    getClosestLeft(key) {
        var _this__findClosest, _getFirstItem;
        let layoutInfo = this.getLayoutInfo(key);
        ...
        let rect = new (0, $bRzF0$Rect)(layoutInfo.rect.x - layoutInfo.rect.width - this.horizontalSpacing - 1, layoutInfo.rect.y, layoutInfo.rect.width + this.horizontalSpacing, layoutInfo.rect.height);
        key = (_this__findClosest = this._findClosest(layoutInfo.rect, rect)) === null || _this__findClosest === void 0 ? void 0 : _this__findClosest.key;
        if (!key) {
            var _this__findClosest1;
            rect = new (0, $bRzF0$Rect)(layoutInfo.rect.x - layoutInfo.rect.width - this.horizontalSpacing - 1, 0, layoutInfo.rect.width + this.horizontalSpacing, this.virtualizer.contentSize.height);
            key = (_this__findClosest1 = this._findClosest(layoutInfo.rect, rect)) === null || _this__findClosest1 === void 0 ? void 0 : _this__findClosest1.key;
        }
        let item = this.collection.getItem(key);
        return (_getFirstItem = (0, $bRzF0$getFirstItem)((0, $bRzF0$getChildNodes)(item, this.collection))) === null || _getFirstItem === void 0 ? void 0 : _getFirstItem.key;
    ...
    constructor(options = {}){
        ...
        super(options);
        this.minItemSize = options.minItemSize || new (0, $bRzF0$Size)(240, 136);
        this.maxItemSize = options.maxItemSize || new (0, $bRzF0$Size)(Infinity, Infinity);
        this.margin = options.margin != null ? options.margin : 24;
        this.minSpace = options.minSpace || new (0, $bRzF0$Size)(18, 18);
