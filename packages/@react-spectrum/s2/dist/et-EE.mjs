...
$8af9e600bb9b26eb$exports = {
    ...
    "tag.hideButtonLabel": `Kuva v\xe4hem`,
    "tag.noTags": `Puudub`,
    "tag.showAllButtonLabel": (args, formatter)=>`Kuva k\xf5ik (${formatter.number(args.tagCount)})`
};


export {$8af9e600bb9b26eb$exports as default};
